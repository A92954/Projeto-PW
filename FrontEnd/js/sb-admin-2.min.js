...
// método para obrigar a preencher a % de sobreviventes
function verificacao() {
  var text = document.getElementById("text");
  if (document.getElementById("N-sobreviventes").value == "%") {
    text.style.display = "block";
    $("#btn_ConcluirOperacao").attr("disabled", true);
  } else {
    text.style.display = "none";
    $("#btn_ConcluirOperacao").attr("disabled", false);
  }
}
