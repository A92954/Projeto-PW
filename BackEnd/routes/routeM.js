...
router.get(
  "/teams/:id_ocorrencia/view_team",
  controllerEquipa.readEquipaOcorrencia
);
...
router.put(
  "/teams/:id_equipa/check_team",
  controllerEquipa.updateConfirmarEquipa
);
router.put(
  "/teams/:id_equipa/credit_team",
  controllerEquipa.updateCreditoEquipa
);
...
router.get(
  "/agents/:id_operacional/accurring",
  controllerOcorrencia.readOcorrenciaAtual
);
router.get("/occurrencesGraphic", controllerOcorrencia.readGrafico);
router.get(
  "/occurrences/:id_ocorrencia/sendmail",
  controllerOcorrencia.readDadosOcorrencia
);
router.get(
  "/occurrences/:id_ocorrencia/timeDiff",
  controllerOcorrencia.readDiferencaTempo
);
router.get(
  "/occurrences/:id_ocorrencia/witnesses",
  controllerOcorrencia.readTestemunha
);
router.put(
  "/occurrences/:id_ocorrencia/credit",
  controllerOcorrencia.updateCreditoOcorrencia
);
router.put(
  "/occurrences/:id_ocorrencia/check_departure",
  controllerOcorrencia.updateConfirmarPartidaOcorrencia
);
router.put(
  "/occurrences/:id_ocorrencia/duration",
  controllerOcorrencia.updateDuracaoOcorrencia
);
router.put(
  "/occurrences/:id_ocorrencia/survival",
  controllerOcorrencia.updatePercentagemSobrevivente
);
router.put(
  "/occurrences/:id_ocorrencia/times",
  controllerOcorrencia.updateTempoDeslocacao
);
...
router.get(
  "/agents/:id_operacional/agent",
  controllerOperacional.readOperacional
);
router.get(
  "/agents/:id_operacional/role",
  controllerOperacional.readEspecialidade
);
router.get(
  "/agents/:id_operacional/occurrence",
  controllerOperacional.readOcorrenciaOperacional
);
router.get(
